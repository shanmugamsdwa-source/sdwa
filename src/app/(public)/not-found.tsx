  ...
  return (
    <main className="min-h-[70vh] flex items-center justify-center bg-[#F8FAFC] py-16 px-4">
      <div className="max-w-md w-full bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-xl text-center space-y-6">
        {/* Animated Badge Icon */}
        <div className="w-16 h-16 rounded-2xl bg-red-50 border border-red-200 flex items-center justify-center text-[#DC2626] mx-auto animate-pulse">
          <ShieldAlert size={32} />
        </div>
        ...
        <div className="space-y-2">
          ...
          <h1 className="font-oswald text-3xl sm:text-4xl font-bold uppercase text-[#0F172A] tracking-tight">
            Record Not Found
          </h1>
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed font-medium">
            The requested championship detail, athletic record, affiliated academy, or official page is missing, was deleted, or has been archived.
          </p>
        </div>
